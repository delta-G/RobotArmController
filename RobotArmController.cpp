...
Joint joints[NUMBER_OF_JOINTS] = {
		Joint(4, 1340, 37, 544, -0.34907, 2400, 3.31613),
		Joint(5, 1250, 105, 544, -0.087266, 2400, 2.91470),
		Joint(6, 1950, 98, 544, 2.96706, 2400, -0.13963),
		Joint(7, 1250, 158, 32, 605, -1.16937, 2400, 2.12930),
		Joint(8, 700, 0, 564, -0.34907, 2400, 3.316126),
		Joint(9, 2250, 0, 1850, 1.923, 2400, PI),
		Joint(A0, 1420, 0, 600, -1.57, 2350, PI),
		Joint(A1, 700, 0, 600, 0.87, 1470, -0.35)
};
